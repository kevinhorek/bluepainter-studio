...
export function evaluateReceipts(nodesMap, component, policy, dismissedRules = new Set()) {
  if (!component || !nodesMap) return { rules: [], scores: { design: 100, accessibility: 100, buildability: 100, total: 100 } };
