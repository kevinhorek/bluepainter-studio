---
title: "How to sync a empty state between canvas and TSX"
description: "Practical id-contract checklist for keeping a empty state editable in BluePainter."
pattern: "how-to-sync"
pubDate: 2026-07-21
---

# How to sync a empty state between canvas and TSX

Practical id-contract checklist for keeping a empty state editable in BluePainter.

## Goal

Keep a **empty state** editable on canvas and in TSX without losing formatting.
