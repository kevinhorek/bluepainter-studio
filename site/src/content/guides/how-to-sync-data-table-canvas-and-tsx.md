---
title: "How to sync a data table between canvas and TSX"
description: "Practical id-contract checklist for keeping a data table editable in BluePainter."
pattern: "how-to-sync"
pubDate: 2026-07-21
---

# How to sync a data table between canvas and TSX

Practical id-contract checklist for keeping a data table editable in BluePainter.

## Goal

Keep a **data table** editable on canvas and in TSX without losing formatting.
